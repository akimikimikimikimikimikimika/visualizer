...
target.nosync/x86_64-apple-darwin/release/visualizer:
	@`flags cargo macos x86_64`

target.nosync/aarch64-apple-darwin/release/visualizer:
	@`flags cargo macos arm64`

target.nosync/x86_64-unknown-linux-gnu/release/visualizer:
	@`flags cargo linux x86_64`

target.nosync/aarch64-unknown-linux-gnu/release/visualizer:
	@`flags cargo linux arm64`

target.nosync/armv7-unknown-linux-gnueabihf/release/visualizer:
